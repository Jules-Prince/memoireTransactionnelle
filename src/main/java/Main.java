...
//          System.out.println("---> " + Memory.memory.values[0].value);
    ...
    public synchronized void testSync() {
        int currentValue = Memory.memory.getValues()[0].getValue();
        Memory.memory.getValues()[0].setValue(currentValue++);
    }
    ...
    public static void main(String args[]) throws Exception {
        ...
        System.out.println("--> " + Memory.memory.getValues()[0].getValue() + " ("
